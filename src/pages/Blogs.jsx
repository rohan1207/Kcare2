          ...
          {blogs.map((blog, index) => (
            ...
            >
              ...
              <div className="p-6 flex-grow flex flex-col">
                <h2 className="text-xl font-bold text-primary-maroon font-display mb-3 flex-grow">{blog.title}</h2>
                <p className="text-deep-wine/80 leading-relaxed mb-6 line-clamp-3">{blog.summary}</p>
                <Link 
                  to={`/blogs/${blog.id}`}
                  className="mt-auto inline-flex items-center gap-2 text-primary-green font-semibold group-hover:text-primary-maroon transition-colors duration-300"
                >
