        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.5, delay: 0.1 }}>
              <h2 className="text-3xl font-bold text-primary-maroon mb-6 font-display">Benefits of Laser Hemorrhoidoplasty</h2>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.5, delay: 0.2 }}>
              <h2 className="text-3xl font-bold text-primary-maroon mb-4 font-display">Advanced Laser Technology</h2>
              <div className="prose prose-lg max-w-none text-deep-wine/90 leading-relaxed">
          ...
          <aside className="lg:col-span-1 space-y-8 lg:sticky lg:top-24 h-fit">
            ...
            >
              <h3 className="text-2xl font-bold text-primary-maroon mb-6 text-center">Get Lasting Relief</h3>
              <p className="text-center text-deep-wine/80 mb-6">Schedule a private consultation to discuss our advanced, painless treatments.</p>
              <Link 
                to="/contact"
