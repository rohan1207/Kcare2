      ...
      <div className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <aside className="lg:col-span-1 space-y-8 lg:sticky lg:top-24 h-fit">
            ...
            >
              <h3 className="text-2xl font-bold text-primary-maroon mb-6 text-center">Book a Consultation</h3>
              <p className="text-center text-deep-wine/80 mb-6">Take the first step towards better health. Our team is here to help.</p>
              <Link 
                to="/contact"
